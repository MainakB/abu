export const ASSERTIONMODES = {
  ...
  DROPDOWNNOTCONTAINS: "DROPDOWNNOTCONTAINS",
  DROPDOWNOPTIONSBYPARTIALTEXT: "DROPDOWNOPTIONSBYPARTIALTEXT",
  ...
  TITLENOTEQUALS: "TITLENOTEQUALS",
  TITLECONTAINS: "TITLECONTAINS",
  TITLENOTCONTAINS: "TITLENOTCONTAINS",

  TITLESTARTSWITH: "TITLESTARTSWITH",
  TITLENOTSTARTSWITH: "TITLENOTSTARTSWITH",
  TITLEENDSSWITH: "TITLEENDSSWITH",
  TITLENOTENDSSWITH: "TITLENOTENDSSWITH",
  ...
  MATCHVARIABLESEQUALS: "MATCHVARIABLESEQUALS",
  MATCHVARIABLESNOTEQUALS: "MATCHVARIABLESNOTEQUALS",
  MATCHVARIABLESCONTAINS: "MATCHVARIABLESCONTAINS",
  MATCHVARIABLESNOTCONTAINS: "MATCHVARIABLESNOTCONTAINS",
  ...
  SINGLEVARASSIGNEMAILCONFIG: "SINGLEVARASSIGNEMAILCONFIG",
  ...
  GENERICVARASSIGN: "GENERICVARASSIGN",

  GENERICVARMATCHEQUALS: "GENERICVARMATCHEQUALS",
  GENERICVARMATCHNOTEQUALS: "GENERICVARMATCHNOTEQUALS",
  GENERICVARMATCHCONTAINS: "GENERICVARMATCHCONTAINS",
  GENERICVARMATCHNOTCONTAINS: "GENERICVARMATCHNOTCONTAINS",

  GENERICVARMATCHSTARTSWITH: "GENERICVARMATCHSTARTSWITH",
  GENERICVARMATCHNOTSTARTSWITH: "GENERICVARMATCHNOTSTARTSWITH",
  GENERICVARMATCHENDSWITH: "GENERICVARMATCHENDSWITH",
...
export const FUNCTIONMAPPER = {
  ...
  CLOSETAB: {
    key: ASSERTIONMODES.CLOSETAB,
    name: "closeTab",
  },
  NEWTAB: {
    key: ASSERTIONMODES.NEWTAB,
    name: "newTab",
  },
  ...
  DROPDOWNNOTCONTAINS: {
    key: ASSERTIONMODES.DROPDOWNNOTCONTAINS,
    name: "assertOptionDontExistsInDropDown",
  },
  DROPDOWNOPTIONSBYPARTIALTEXT: {
    key: ASSERTIONMODES.DROPDOWNOPTIONSBYPARTIALTEXT,
    name: "assertSomeDropContainsOptWithPartialTxt",
  },
  ...
  SINGLEVARASSIGNEMAILCONFIG: {
    key: ASSERTIONMODES.SINGLEVARASSIGNEMAILCONFIG,
    name: "PLACEHOLDER",
  },
  ...
  HTTPHOST: {
    key: ASSERTIONMODES.HTTPHOST,
    name: "httpUrl",
  },
  HTTPPATH: {
    key: ASSERTIONMODES.HTTPPATH,
    name: "path",
  },
  HTTPHEADER: {
    key: ASSERTIONMODES.HTTPHEADER,
    name: "header",
  },
  HTTPHEADERS: {
    key: ASSERTIONMODES.HTTPHEADERS,
    name: "headers",
  },
  HTTPPAYLOAD: {
    key: ASSERTIONMODES.HTTPPAYLOAD,
    name: "payload",
  },
  HTTPMETHOD: {
    key: ASSERTIONMODES.HTTPMETHOD,
    name: "method",
  },
  HTTPSTATUS: {
    key: ASSERTIONMODES.HTTPSTATUS,
    name: "status",
  },
  MATCHVARIABLESEQUALS: {
    key: ASSERTIONMODES.MATCHVARIABLESEQUALS,
    name: "match",
  },
  MATCHVARIABLESNOTEQUALS: {
    key: ASSERTIONMODES.MATCHVARIABLESNOTEQUALS,
    name: "match",
  },
  MATCHVARIABLESCONTAINS: {
    key: ASSERTIONMODES.MATCHVARIABLESCONTAINS,
    name: "match",
  },
  MATCHVARIABLESNOTCONTAINS: {
    key: ASSERTIONMODES.MATCHVARIABLESNOTCONTAINS,
    name: "match",
  },
  GENERICVARASSIGN: {
    key: ASSERTIONMODES.GENERICVARASSIGN,
    name: "def",
  },

  GENERICVARMATCHEQUALS: {
    key: ASSERTIONMODES.GENERICVARMATCHEQUALS,
    name: "==",
  },
  GENERICVARMATCHNOTEQUALS: {
    key: ASSERTIONMODES.GENERICVARMATCHNOTEQUALS,
    name: "!=",
  },
  GENERICVARMATCHCONTAINS: {
    key: ASSERTIONMODES.GENERICVARMATCHCONTAINS,
    name: "contains",
  },
  GENERICVARMATCHNOTCONTAINS: {
    key: ASSERTIONMODES.GENERICVARMATCHNOTCONTAINS,
    name: "not contains",
  },

  GENERICVARMATCHSTARTSWITH: {
    key: ASSERTIONMODES.GENERICVARMATCHSTARTSWITH,
    name: "starts with",
  },
  GENERICVARMATCHNOTSTARTSWITH: {
    key: ASSERTIONMODES.GENERICVARMATCHNOTSTARTSWITH,
    name: "not starts with",
  },
  GENERICVARMATCHENDSWITH: {
    key: ASSERTIONMODES.GENERICVARMATCHENDSWITH,
    name: "ends with",
  },
  GENERICVARMATCHNOTENDSWITH: {
    key: ASSERTIONMODES.GENERICVARMATCHNOTENDSWITH,
    name: "not ends with",
  },
  GETEMAIL: {
    key: ASSERTIONMODES.GETEMAIL,
    name: "getEmail",
  },
  DELETEEMAIL: {
    key: ASSERTIONMODES.DELETEEMAIL,
    name: "deleteEmail",
  },
  DELETEALLEMAIL: {
    key: ASSERTIONMODES.DELETEALLEMAIL,
    name: "deleteAllEmail",
  },
  GETTITLE: {
    key: ASSERTIONMODES.GETTITLE,
    name: "title",
  },

  TITLEEQUALS: {
    key: ASSERTIONMODES.TITLEEQUALS,
    name: "title",
  },
  TITLENOTEQUALS: {
    key: ASSERTIONMODES.TITLENOTEQUALS,
    name: "title",
  },
  TITLECONTAINS: {
    key: ASSERTIONMODES.TITLECONTAINS,
    name: "title",
  },
  TITLENOTCONTAINS: {
    key: ASSERTIONMODES.TITLENOTCONTAINS,
    name: "title",
  },

  TITLESTARTSWITH: {
    key: ASSERTIONMODES.TITLESTARTSWITH,
    name: "title",
  },
  TITLENOTSTARTSWITH: {
    key: ASSERTIONMODES.TITLENOTSTARTSWITH,
    name: "title",
  },
  TITLEENDSSWITH: {
    key: ASSERTIONMODES.TITLEENDSSWITH,
    name: "title",
  },
  TITLENOTENDSSWITH: {
